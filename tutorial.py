...
def enemy_action(enemy, player, objects):
    enemy.x_vel = 0
    collide_left = collide(enemy, objects, -PLAYER_VEL * 2)
    collide_right = collide(enemy, objects, PLAYER_VEL * 2)
...
def main(window):
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if abs(enemy.rect.x - player.rect.x) <= 2:
                player.make_hit()
